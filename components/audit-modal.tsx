  ...
  return (
    <div className="fixed z-20 inset-0 bg-gray-800 bg-opacity-70 flex justify-center items-center">
      <div className="bg-[#0a0a0a] p-6 rounded-lg max-w-4xl w-full h-[90vh]">
        ...
        <div className="bg-[#0a0a0a]/50 p-4 mt-10 mb-10 rounded-lg text-white placeholder-white max-w-4xl w-full overflow-scroll h-[500px] border border-white">
          <ReactMarkdown className="overflow-scroll">{auditMarkdown}</ReactMarkdown>
        </div>
        <p className="text-center mt-4 animate-bounce bg-clip-text text-transparent bg-gradient-to-r from-cyan-500 to-purple-500">
