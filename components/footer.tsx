...
const Footer: React.FC = () => {
  ...
  return (
    <footer
      className={cn(
        "w-full text-white absolute bottom-0 left-0 right-0 z-[999] p-4 flex justify-center",
      )}
    >
      {/* <StolenMoneyTracker /> */}
      {/* <div className="w-72">
      ...
      <div className="flex gap-8 items-center w-full justify-end *:cursor-pointer z-10 max-w-[1200px]">
        <Link
        ...
        >
          <svg viewBox="0 0 24 24" width="auto" height="24" stroke="white">
            <g>
